...
add_input_table(G, script_name=script,
                ...
                db_name='edl_ods')
add_input_table(G, script_name=script,
                table_name='edl_ods.vw_dg_l1_dg_conti_cliente_bi',
                db_name='edl_ods')
add_input_table(G, script_name=script,
                table_name='edl_ods.vw_fcf_blocchi_fatturazione',
                db_name='edl_ods')
add_input_table(G, script_name=script,
...
add_input_table(G, script_name=script,
                table_name='edl_ods.vw_fcf_lettura_gas',
                db_name='edl_ods')
add_input_table(G, script_name=script,
                table_name='edl_ods.vw_fcf_lettura_pwr',
                db_name='edl_ods')
add_input_table(G, script_name=script,
...
add_input_table(G, script_name=script,
                ...
                db_name='lab1_db')
add_input_table(G, script_name=script,
                table_name='lab1_db.rfcf_tariffario_xe_indici_fatturazione_default',
                db_name='lab1_db')
...
add_output_table(G, script_name=script,
                 ...
                 db_name='lab1_db')
add_output_table(G, script_name=script,
                 table_name='lab1_db.rfcf_tariffario_xe_controllo_disallineamenti',
                 db_name='lab1_db')
...
pd.Series([x for x in only_input_tables if x.find('lab1_db.')==-1]).to_excel('input_tables_edl.xlsx')
pd.Series([x for x in only_input_tables if x.find('lab1_db.')!=-1]).to_excel('config_tables_lab1db.xlsx')
pd.Series([x for x in only_output_tables if x.find('lab1_db.')!=-1]).to_excel('tab_solo_output_lab1db.xlsx')
...
G.remove_node('FCF/cash_flow/src/data/setup/RFCF_01_start_run.py')
all_scripts.remove('FCF/cash_flow/src/data/setup/RFCF_01_start_run.py')
G.remove_node('lab1_db.rfcf_storico_run_cashflow')
G.remove_node('lab1_db.rfcf_run_snapshot_cashflow')

G.remove_node('FCF/cash_flow/src/data/setup/RFCF_04_end_run.py')
all_scripts.remove('FCF/cash_flow/src/data/setup/RFCF_04_end_run.py')
